...
class _ProfilePageState extends State<ProfilePage> {
  ...
  Widget build(BuildContext context) {
    return RefreshIndicator(
      onRefresh: () async => fetchUserDetail(),
      child: FutureBuilder(
                  ...
                  Padding(
                    ...
                    child: Column(
                      ...
                      children: [
                        ...
                        if (user.status == 'suspend') const Gap(20),
                        if (user.status == 'suspend')
                          Container(
                            padding: const EdgeInsets.all(14),
                            decoration: BoxDecoration(borderRadius: BorderRadius.circular(6), border: Border.all(color: Colors.red)),
                            child: Text(
                              'Your Account is Suspend, please contact our customer support.',
                        ...
                        const Gap(10),
                        InfoLine(title: 'Curren Status', value: user.status.toUpperCase()),
                        const Gap(10),
